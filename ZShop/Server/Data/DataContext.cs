...
namespace ZShop.Server.Data
{
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.SharedTypeEntity<Dictionary<string, object>>("PlatformProduct")
                .HasData(
                    new { PlatformsId = 1, ProductsId = 1 },
                    new { PlatformsId = 4, ProductsId = 1 },
                    new { PlatformsId = 5, ProductsId = 1 },
                    new { PlatformsId = 4, ProductsId = 3 },
                    new { PlatformsId = 3, ProductsId = 4 },
                    new { PlatformsId = 4, ProductsId = 4 },
                    new { PlatformsId = 1, ProductsId = 5 },
                    new { PlatformsId = 4, ProductsId = 5 },
                    new { PlatformsId = 5, ProductsId = 5 },
                    new { PlatformsId = 4, ProductsId = 6 },
                    new { PlatformsId = 4, ProductsId = 7 },
                    new { PlatformsId = 5, ProductsId = 8 },
                    new { PlatformsId = 4, ProductsId = 8 },
                    new { PlatformsId = 4, ProductsId = 9 },
                    new { PlatformsId = 5, ProductsId = 10 },
                    new { PlatformsId = 4, ProductsId = 10 },
                    new { PlatformsId = 8, ProductsId = 11 },
                    new { PlatformsId = 4, ProductsId = 11 },
                    new { PlatformsId = 4, ProductsId = 13 },
                    new { PlatformsId = 1, ProductsId = 14 },
                    new { PlatformsId = 2, ProductsId = 14 },
                    new { PlatformsId = 4, ProductsId = 14 },
                    new { PlatformsId = 5, ProductsId = 14 },
                    new { PlatformsId = 6, ProductsId = 14 },
                    new { PlatformsId = 8, ProductsId = 15 },
                    new { PlatformsId = 3, ProductsId = 15 },
                    new { PlatformsId = 4, ProductsId = 15 },
                    new { PlatformsId = 1, ProductsId = 16 },
                    new { PlatformsId = 4, ProductsId = 16 },
                    new { PlatformsId = 5, ProductsId = 16 },
                    new { PlatformsId = 1, ProductsId = 22 },
                    new { PlatformsId = 2, ProductsId = 22 },
                    new { PlatformsId = 4, ProductsId = 22 },
                    new { PlatformsId = 5, ProductsId = 22 },
                    new { PlatformsId = 6, ProductsId = 22 },
                    new { PlatformsId = 3, ProductsId = 23 },
                    new { PlatformsId = 4, ProductsId = 23 },
                    new { PlatformsId = 7, ProductsId = 23 },
                    new { PlatformsId = 8, ProductsId = 23 },
                    new { PlatformsId = 1, ProductsId = 24 },
                    new { PlatformsId = 2, ProductsId = 24 },
                    new { PlatformsId = 3, ProductsId = 24 },
                    new { PlatformsId = 4, ProductsId = 24 },
                    new { PlatformsId = 5, ProductsId = 24 },
                    new { PlatformsId = 6, ProductsId = 24 },
                    new { PlatformsId = 7, ProductsId = 24 },
                    new { PlatformsId = 8, ProductsId = 24 }
                );
        }
    }
}
