...
namespace ZShop.Server.Data.Migrations
{
    ...
    [Migration("20210824082626_CreateIdentitySchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ZShop.Shared.ProductVariant", b =>
                {
            ...
            modelBuilder.Entity("ZShop.Shared.Stats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ZShop.Shared.ProductVariant", b =>
                {
                    b.HasOne("ZShop.Shared.Platform", "Platform")
                        .WithMany()
                        .HasForeignKey("PlatformId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ZShop.Shared.Product", "Product")
                        .WithMany("Variants")
